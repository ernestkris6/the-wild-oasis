...
function CreateCabinForm() {
  ...
  //you invalidate so that the data is refetched (useQuery in cabin table component) and the ui is updated. 
...
{/* 
      ...
      {/* <FormRow2>
        ...
        type="number" 
        id="discount" 
        defaultValue={0} {...register("discount", {required: "This field is required", validate: (value) => value <= getValues().regularPrice || "Discount should be less than regular price."})}/>
      </FormRow2> */}
